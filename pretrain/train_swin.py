...
import torchvision
import argparse
from modules import transform, resnet, network_swin, contrastive_loss
...
if __name__ == "__main__":
    ...
    config = yaml_config_hook("./config/config_swin.yaml")
    ...
    model = network_swin.Network(args.vit_type, args.feature_dim, class_num)
